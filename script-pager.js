...
(function () {
  ...
  const STOPWORDS = new Set([
    ...
    "not", "no", "so", "into", "about", "when", "who", "what", "how", "receives", "does", "already", "before", "after", "identity", "divided", "runs", "assumed", "encoded", "itself", "sets", "fully", "calls", "holds", "gives", "mechanism", "different", "story", "enforce", "enforces", "enforced", "enforcement", "same", "current", "prior", "form", "under", "over", "instrument", "began", "each", "different", "cannot", "other", "goes", "removes", "that the", "running", "over", "under", "until", "within", "engine", "each", "requires", "require", "present", "presents", "against","that's","reads","once", "given","things","category","categories", "declaration", "statute","inside","held","must","enclosure","demonstration", "answers","encodes","scattered","fold","establishes","consciousness","will","long","thread","asked","directly","inside","filing","file","verdict","full","always","reading","vocabulary","internal","written","apart","none","visible","structure","thread","where","wrong","passage", "scripture","verse","without","called","condition","filled","done","work", "closes","stands","record"
  ]);
