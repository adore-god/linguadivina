...
(function () {
  ...
  const STOPWORDS = new Set([
    ...
    "not", "no", "so", "into", "about", "when", "who", "what", "how", "receives", "does", "already", "before", "after", "identity", "divided", "runs", "assumed", "encoded", "itself", "sets", "fully", "calls", "holds", "gives", "mechanism", "different", "story", "enforce", "enforces", "enforced", "same", "current", "prior", "form", "under", "over", "instrument", "began", "each", "different", "cannot", "other", "goes", "removes", "that the", "running", "over", "under", "until", "within", "engine", "each", "requires", "require", "present", "presents", "against","that's","reads","once", "given","things","category","categories", "declaration", "statute","inside","held","must","enclosure","demonstration", "answers","encodes"
  ]);
