...
const ARTICLE_STYLE = `
  ...
  h1 {position:absolute: width:100%;padding: 1.3em 1em 1.3em 0.5em; background: ${BRAND_COLOR_DARK}; color: ${BRAND_COLOR_WHITE};text-align:left;  margin-bottom:1em; font-size: 1.5em; line-height:1.4; }
