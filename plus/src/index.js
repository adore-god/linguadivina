...
const INDEX_STYLE = `
  ...
  .article-body { width:90%; padding: 0;  margin: 3em auto;}
  .free-link {margin-top:4px;opacity:0.5;font-size:0.6em; text-transform:uppercase; display: block;}
  .free-link a:link {padding:4px 6px;border-radius:6px;background: ${BRAND_COLOR_WHITE}; color: ${BRAND_COLOR_DARK};}
  ...
  .art-list ul li a:visited { color: var(--visited); }
    .art-list ul li a:hover { color: var(--bright-navy); text-decoration:none;font-weight:600; }
  ...
  "@graph": [
    {
      ...
      "description": "Original linguistic framework — Lingua Divina — developed by HNNH, tracing the Bible's own symbolic vocabulary — court, name, seed, light — through the underlying Hebrew and Greek, verse by verse. The consciousness and identity themes are drawn from what the narrative itself encodes, not imposed on it.",
      "founder": {
